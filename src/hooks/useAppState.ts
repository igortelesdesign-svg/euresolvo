  ...
  useEffect(() => {
    ...
    setIsAuthenticated(true);
      ...
      const restoredUser: UserProfile = {
        ...
        professionalCategory: authUser.user_metadata?.professional_category || undefined,
        ...
        options: {
          data: {
            ...
            professional_category:
              newUser.role === 'professional' ? newUser.professionalCategory : null,
            phone: newUser.phone,
      ...
      if (data.session) {
        ...
        if (createdUser.role === 'professional') {
          const newPro: ProfessionalProfile = {
            ...
            userId: data.user.id,
            bio: 'Profissional capacitado pronto para atender com qualidade e pontualidade.',
            mainCategory: createdUser.professionalCategory || 'Não informado',
            categories: createdUser.professionalCategory ? [createdUser.professionalCategory] : [],
            subcategories: [],
            experienceYears: 5,
            rating: 0,
            totalReviews: 0,
  ...
  const loginUser = useCallback(
    async (email: string, password: string): Promise<boolean> => {
      ...
      const loggedUser: UserProfile = {
        ...
        name: profile.name,
        professionalName: profile.professional_name || undefined,
        professionalCategory: data.user.user_metadata?.professional_category || undefined,
        role: profile.role as UserProfile['role'],
        phone: privateData?.phone || undefined,
        whatsapp: privateData?.whatsapp || undefined,
        whatsappNotifications:
      ...
      if (loggedUser.role === 'professional') {
        setProfessionals((prev) => {
          ...
          const newPro: ProfessionalProfile = {
            ...
            bio: 'Profissional capacitado pronto para atender com qualidade e pontualidade.',
            mainCategory: loggedUser.professionalCategory || 'Não informado',
            categories: loggedUser.professionalCategory ? [loggedUser.professionalCategory] : [],
            subcategories: [],
            experienceYears: 0,
            rating: 0,
            totalReviews: 0,
